...
CCfg::CCfg()
{
	...
	std::strcpy(m_acInVdoPth, "/home/ai_students/r_aicity/AICity/AICity_TeamUW-master/DET_MST_IPL/data/a.mp4");	// in Linux
	//std::strcpy(m_acInFrmPth, ".\\data\\frm.jpg");	// in Windowse
	std::strcpy(m_acInFrmPth, "/home/ai_students/r_aicity/AICity/AICity_TeamUW-master/DET_MST_IPL/data/frm.jpg");	// in Linux
	//std::strcpy(m_acInRoiPth, ".\\data\\roi.jpg");	// in Windows
	std::strcpy(m_acInRoiPth, "/home/ai_students/r_aicity/AICity/AICity_TeamUW-master/DET_MST_IPL/data/roi.jpg");	// in Linux
	//std::strcpy(m_acInDetTxtPth, ".\\data\\det\\det.txt");	// in Windows
	std::strcpy(m_acInDetTxtPth, "/home/ai_students/r_aicity/AICity/AICity_TeamUW-master/DET_MST_IPL/datadet/det.txt");	// in Linux
	//std::strcpy(m_acOutDetTxtPth, ".\\data\\det\\det.txt");	// in Windows
	std::strcpy(m_acOutDetTxtPth, "/home/ai_students/r_aicity/AICity/AICity_TeamUW-master/DET_MST_IPL/datadet/det.txt");	// in Linux
	//std::strcpy(m_acOutVdoPth, ".\\data\\outVdo.avi");	// in Windows
	std::strcpy(m_acOutVdoPth, "/home/ai_students/r_aicity/AICity/AICity_TeamUW-master/DET_MST_IPL/data/outVdo.avi");	// in Linux
	//std::strcpy(m_acOutImgFlrPth, ".\\data\\outImg1\\");	// in Windows
	std::strcpy(m_acOutImgFlrPth, "/home/ai_students/r_aicity/AICity/AICity_TeamUW-master/DET_MST_IPL/data/outImg1/");	// in Linux
	//std::strcpy(m_acOutTstpPth, ".\\data\\tstp.txt");	// in Windows
	std::strcpy(m_acOutTstpPth, "/home/ai_students/r_aicity/AICity/AICity_TeamUW-master/DET_MST_IPL/datatstp.txt");	// in Linux
	m_nInVdoTyp = 0;
	m_nInDetTyp = 2;
	m_bOutDetFlg = false;
	m_bOutVdoFlg = false;
...
void CCfg::loadCfgFile()
{
	...
	poCfgFile = std::fopen("/home/ai_students/r_aicity/AICity/AICity_TeamUW-master/DET_MST_IPL/data/cfg.json", "r");	// in Linux
